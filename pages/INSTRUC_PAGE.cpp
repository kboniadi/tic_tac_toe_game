...
void Render_INSTRUC_PAGE(INSTRUC_PAGE *instruc_page)
{
	...
	GuiGetStyle(DEFAULT, TEXT_SPACING)).x, (float) GuiGetStyle(DEFAULT, TEXT_SIZE)}, "This is a game of Tic Tac Toe!");
	...
	GuiGetStyle(DEFAULT, TEXT_SPACING)).x, (float) GuiGetStyle(DEFAULT, TEXT_SIZE)}, "In this game you'll be able to play in single player or multiplayer mode.");
	...
	GuiGetStyle(DEFAULT, TEXT_SPACING)).x, (float) GuiGetStyle(DEFAULT, TEXT_SIZE)}, "Users will first have to enter their name(s) and in the case of the single");
	...
	GuiGetStyle(DEFAULT, TEXT_SPACING)).x, (float) GuiGetStyle(DEFAULT, TEXT_SIZE)}, "player mode pick a difficulty. After, a player will then be picked at random");
	...
	GuiGetStyle(DEFAULT, TEXT_SPACING)).x, (float) GuiGetStyle(DEFAULT, TEXT_SIZE)}, "to start and the goal will be to get three of your tokens in a row.");
	...
	GuiGetStyle(DEFAULT, TEXT_SPACING)).x, (float) GuiGetStyle(DEFAULT, TEXT_SIZE)}, "Good Luck!");
